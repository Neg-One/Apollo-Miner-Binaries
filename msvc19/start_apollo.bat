...
pushd "%~dp0"
.\apollo-miner.exe -host stratum+tcp://us-east.stratum.slushpool.com:3333 -port 3333 -user Neg-One.ApolloBTC1 -pswd Admin123 -comport COM4 -brd_ocp 48  -osc 30 -ao_mode 1
pause
